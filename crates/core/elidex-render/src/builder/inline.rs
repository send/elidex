...
use super::inline_flow::{emit_inline_flow, fragment_matches_page};
use super::{
    apply_opacity, bidi_visual_order, collapse_segments, compute_text_align_offset,
    find_nearest_layout_box, place_glyphs, place_glyphs_vertical, resolve_text_align, PaintContext,
...
impl StyledTextSegment {
    ...
    pub(super) fn from_style(text: String, style: &ComputedStyle) -> Self {
        Self {
            text,
            color: style.color,
...
pub(super) fn emit_text_segment(
    text: &str,
...
pub(super) fn vertical_text_orientation(
...
#[allow(clippy::too_many_arguments)]
pub(super) fn emit_vertical_text_segment(
    text: &str,
    seg: &StyledTextSegment,
    text_orientation: TextOrientation,
    center_x: f32,
