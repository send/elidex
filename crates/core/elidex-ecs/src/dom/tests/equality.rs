...
fn nodes_equal_per_kind_branches() {
    ...
    assert!(dom.set_attribute(same_attrs_lhs, "id", "x").did_set);
    assert!(dom.set_attribute(same_attrs_lhs, "class", "y").did_set);
    assert!(dom.set_attribute(same_attrs_rhs, "class", "y").did_set);
    assert!(dom.set_attribute(same_attrs_rhs, "id", "x").did_set);
    ...
    assert!(dom.set_attribute(differ_lhs, "id", "x").did_set);
    assert!(dom.set_attribute(differ_rhs, "id", "z").did_set);
