...
fn classify(kind: &ObjectKind) -> CloneKind {
    match kind {
        ...
        // SW client objects (§3.1/§3.2) are not [Serializable] — identity is
        // per-realm (one object per scope, D-19 PR-3).
        #[cfg(feature = "engine")]
        ...
        ObjectKind::CSSStyleDeclaration { .. } => CloneKind::Unclonable("CSSStyleDeclaration"),
