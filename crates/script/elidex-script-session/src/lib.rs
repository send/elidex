...
pub use mutation::{
    ...
    apply_replace_child, apply_set_inner_html, apply_set_outer_html, convert_arg_source_records,
    Mutation, MutationKind, MutationRecord, OuterHtmlError, SetInnerHtmlOptions,
};
