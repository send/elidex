...
fn box_sizing_border_box_height() {
    let style = ComputedStyle {
        display: Display::Block,
        height: Dimension::Length(100.0),
        padding: EdgeSizes { top: 10.0, right: 0.0, bottom: 10.0, left: 0.0 },
        border_top: BorderSide { width: 2.0, ..BorderSide::NONE },
        border_bottom: BorderSide { width: 2.0, ..BorderSide::NONE },
