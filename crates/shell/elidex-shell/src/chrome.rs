...
/// The content-area size (logical CSS px) the page renders into: the window
/// inner size minus the chrome reserved for the address bar + tab strip.
///
/// The CSS cascade / `@media` width-height / `innerWidth`/`innerHeight` /
/// scrolling must see this, NOT the full window — the sibling
