...
| 11 | [HTMLパーサー](11-parser-design.md) | 厳格コアパーサー、compatエラー回復、LLM修復 |
...
| 14 | [スクリプトエンジン＆Web API](14-script-engines-webapi.md) | SpiderMonkey、elidex-js、wasmtime、Web APIバインディング |
...
35件のアーキテクチャ決定記録の全体は [第28章 (ADR)](28-adr.md) を参照。
