...
Own-deferral count: **2** (`#11-inline-box-decoration-splits`, `#11-inline-min-content-box-edges`); `#11-inline-root-inline-box` is pre-existing class. Within the per-PR ≤3 policy.
