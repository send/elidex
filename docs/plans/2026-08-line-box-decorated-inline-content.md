...
has layout and intrinsic sizing disagreeing **on the edge terms** — A47's ground, met, for what it
covers — and §6 routes cell 25 to it. An atomic inline's contribution disagrees on every commit
...
neither min-content-specific nor decoration-specific, and §8 names two measured instances rather
than three. It is **registered**, not dismissed (Codex R27; ledger **A61**): `#11-inline-atomic-intrinsic-contribution` (§5.3, §10),
...
* **Intrinsic sizing** — per M8: both edge terms are **in PR-1b**; min-content's cross-item
  ...
  has no accumulator to attach edges to and PR-1b is not correct without it; an atomic inline's own contribution, zero in both passes before and after, is `#11-inline-atomic-intrinsic-contribution`'s (§5.3). ⚠ **It was slotted until
