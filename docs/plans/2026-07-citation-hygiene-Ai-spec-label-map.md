...
The wire computes no set difference at all: it scans, and it fails on **§2's K2 predicate** — the single
absolute it carries. ⚠ **This sentence named a separate pin until #501 R75**; that pin was measured to be
