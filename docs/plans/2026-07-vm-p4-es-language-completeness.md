...
followed the stated walk. ⚠ **The answer is NOT a closure rule — that was tried and is withdrawn just
below; this paragraph states the problem, and the paragraph after it states the one procedure.** **So a derivation states its SEED and nothing more, and the closure machinery that stood here is
