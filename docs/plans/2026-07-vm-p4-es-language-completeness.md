...
holding the tagged call. It is **4a + 4c** below, and the row records the criterion that decides
both directions rather than the two verdicts it has now overturned.
...
for the reason its row states. 4a depends on **1b** (I-3
