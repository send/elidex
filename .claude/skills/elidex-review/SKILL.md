...
Step 3.5 で emit した **Fix decision F<N>** block 群を referenced して user に:
...
を確認。Auto-fix はしない (user 判断 driven)。Step 3.5 block が無いまま Step 4 へ入ったら gate を満たしていない — Step 3.5 へ戻る。
