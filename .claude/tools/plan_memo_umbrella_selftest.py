...
`plan_memo_selftest_mutants.py` (the pre-converge rows + the runner) and
`plan_memo_selftest_mutants_pr510.py` (the PR #510 review-round rows, appended
to the same `MUTANTS`), split at the same seam.
