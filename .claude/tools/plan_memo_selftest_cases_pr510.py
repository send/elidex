...
The middle module of the control registry, split from
`plan_memo_selftest_cases.py` at the review-round seam: that module holds the
fixture builder, the record shape and the pre-converge controls (the four
kinds, the assertion / lexing / exit-status / `/code-review high` /
`/elidex-review` Stage 6 families); this one holds the controls written against
PR #510's Codex R1-R16 and the design re-gates over R4-R9 -- the lexical
